...
#      $Id: Makefile,v 1.23 1997/08/22 17:13:54 mjr Exp mjr $
#
...
TARFILES=Makefile *.pl home.include bin \
	-C data      mvhs.adr \
	-C $(BINDIR) mv_make \
	-C $(CGIDIR) cgi-lib.pl
...
$(WWWDIR)/index.html:	home.include bin/mv_home_html mv_util.pl
	bin/mv_home_html -i home.include
